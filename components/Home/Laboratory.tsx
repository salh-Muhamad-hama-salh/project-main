...
import laboratoryimage from "@/public/images/laboratoryimage.png";
import laboratoryimageone from "@/public/images/laboratoryimageone.svg";
import laboratoryimagetwo from "@/public/images/laboratoryimagetwo.svg";
import laboratoryimagethree from "@/public/images/laboratoryimagethree.svg";
import laboratoryimagefour from "@/public/images/laboratoryimagefour.svg";
    ...
    <div className="bg-white h-full w-full">
      ...
      <div className="flex items-center justify-center gap-[100px] pb-[100px]">
        <div className="hidden xl:flex pt-[20px]">
          <Image src={laboratoryimage} alt="hospitalimage" />
        </div>
        <div className="flex items-center gap-[50px] mt-12 xl:mt-0">
          <div className="flex flex-col items-center relative">
            <Image
              src={laboratoryimageone}
